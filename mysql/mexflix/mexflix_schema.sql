...
CREATE TABLE movieseries(
  ...
  /*Debemos decir que sucedera cuando se elimine/actualize datos
  */
...
/*precargamos 2 usuarios para pruebas*/

INSERT INTO users (user , email, name ,birthday, pass, role) VALUES
 ('@diego','diegolu7@gmail.com','Diego F Luis','1991-10-30', MD5('123456'),'Admin'),
 ('@tico','tico@gmail.com','Tico Luis','1994-10-14',MD5('123456'),'User');
